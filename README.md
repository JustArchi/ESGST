...
For general support in regards to ESGST (e.g. bugs), you should use **[original repo issues](https://github.com/rafaelgomesxyz/esgst/issues)**, as we do not offer any of that.
